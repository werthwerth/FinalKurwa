...
namespace Final.Models
{
    public class RegisterModel : BaseModel
    {
        ...
        public RegisterModel(string _sessionId, DB _db) : base(_sessionId, _db) { }
        public RegisterModel(string _login, string _password, string _firstName, string _lastName, string _email, Core.DB _db, string? _sessionId)
        {
